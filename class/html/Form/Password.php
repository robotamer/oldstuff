<?php
/**
 * $Id: Password.php 1631 2007-05-12 22:40:28Z matthieu $
 */
if (!class_exists('Form_Password')) {
     ...
     * @package html
     */
    class Form_Password extends Form_Object implements Html_Design_Interface
    {
        /**
         * builder
        ...
        */
        ...
        {
            return '<input type="password" ' . $this->getSerializedElements() . '/>';
        }
    }
}