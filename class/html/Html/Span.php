<?php
/**
 * $Id: Span.php 1631 2007-05-12 22:40:28Z matthieu $
 */
if (!class_exists('Html_Span')) {
     ...
     * License @package html
     */
    class Html_Span extends Html_Element implements Html_Design_Interface {
        /**
         * @access protected
         * @var string $_content : the span content
         */
        protected $_content = '&nbsp;';
        /**
         * @acces public
        ...
        */
        ...
        public function __toString() {
            ...
            return '<span' . $elements . '>' . $this->_content . '</span>';
        }
    }
}