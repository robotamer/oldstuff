...
/*
 * Modified for the RoboTamer Framework
 */
class Table {
    ...
    public function set_template($template) {
        if ( ! is_array($template) ) $this->template = $this->default_template();
    ...
    public function setHeadFromKeys($array){
		if(is_array($array))
			$this->heading = array_keys($array);
    }
    ...
    private function default_template(
        ...
        return  array (
                ...
                'heading_row_start'  => '<tr style="background-color: '.$colerh.';">',
                'heading_row_end'    => '</tr>',
                'heading_cell_start' => '<th style="text-align:center;">',
                'heading_cell_end'   => '</th>',

                'row_start'  => '<tr style="background-color: '.$coler1.';">',
                'row_end'    => '</tr>',
                'cell_start' => '<td style="text-align:center;">',
                'cell_end'   => '</td>',

                'row_alt_start'  => '<tr style="background-color: '.$coler2.';">',
                'row_alt_end'    => '</tr>',
     ...
     * @return  void
     */
    private function default_template2() {
        return  array (
                'table_open'        => '<table border="1" cellpadding="4" cellspacing="0">',
